...
public class availComMenuFragment extends ListFragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		String[] colors = getResources().getStringArray(R.array.libNames);
	...
	public void onListItemClick(ListView lv, View v, int position, long id) {
		...
		case 0:
			if(ab.getTitle().toString().equals(getString(R.string.openingHours))){
				...
				newContent = new availComContentFrag();
			}
			break;
		case 1:
		...
		newContent = null;
		availCom fca = (availCom) getActivity();
